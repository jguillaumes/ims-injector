...
func main() {
	...
	clientID := flag.String("c", "INJECTOR", "Client ID for the connection (default: generated by IMS system)")
	...
	verbose := flag.Int("v", 0, "Enable verbose logging (default: 0, no debug)")
